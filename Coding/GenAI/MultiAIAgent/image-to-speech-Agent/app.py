...
def generate_speech_from_text_old(message: str) -> Any:
    """
...
def generate_speech_from_text(message: str) -> None:
    """
    A function using the pyttsx3 text-to-speech library
    :param message: short story or text input
    :return: generates and saves the audio file locally
    """
    engine = pyttsx3.init()
    ...
    # Generate speech
    engine.save_to_file(message, "generated_audio.mp3")
    
    # Run and wait until the speaking process is complete
    engine.runAndWait()
...
def main() -> None:
    ...
    if uploaded_file is not None:
        ...
        st.audio(r"H:\Interview Preparation\Coding\GenAI\Nexus AI\generated_audio.mp3")
