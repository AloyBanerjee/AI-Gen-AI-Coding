...
st.set_page_config(
    page_title="Agents Powered by Groq",
...
# tab configuration
tab1, tab2 = st.tabs(["⚙️ MOA Configuration", "💬 Chat Bot"])

with tab1:
    col1, col2 = st.columns([2, 1])
    with col1:
        st.title("MOA Configuration", anchor=False)
    with col2:
        st.markdown("<a href='https://groq.com'><img src='app/static/banner1.png' width='500'></a>", unsafe_allow_html=True)
