...
# ===========================
st.markdown("""
    # Complex Document RAG - Powered by <img src="data:image/png;base64,{}" width="220" style="vertical-align: top; margin: 0px 5px; float:right;" width="100px">
""".format(base64.b64encode(open(r"H:\Interview Preparation\Coding\GenAI\Tryouts\28-GroundX RAG\assets\deep-seek.png", "rb").read()).decode()), unsafe_allow_html=True)
